...
int collision(int rowA, int colA, int heightA, int widthA, int rowB, int colB, int heightB, int widthB) {
    ...
    return rowA < rowB + heightB - 5 && rowA + heightA - 5 > rowB
        && colA < colB + widthB - 1 && colA + widthA - 1 > colB;
}

int clashing(int rowA, int colA, int heightA, int widthA, int rowB, int colB, int heightB, int widthB) {
    // if (rowA >= rowB && rowA + heightA - 1 <= rowB + heightB - 1 && colA >= colB && colA + widthA - 1 <= colB + heightB - 1) {
    //     return 1;
    // } else {
    //     return 0;
    // }
    ...
    return rowA < rowB + heightB - 5 && rowA + heightA - 5 > rowB
        && colA < colB + widthB - 1 - widthA && colA + widthA - 1 > colB;
}
...
void hideSprites() {
    ...
    for (int i = 0; i < 128; i++) {
        shadowOAM[i].attr0 = shadowOAM[i].attr0 | ATTR0_HIDE;
    }
}