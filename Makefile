...
SOURCES            = myLib.c main.c startScreen.c instructScreen1.c instructScreen2.c instructScreen3.c instructScreen4.c instructScreen5.c charScreen.c loseScreen.c winScreen.c pauseScreen.c gameBG1.c gameBG2.c game.c spriteSheet.c sound.c GameSong.c titleSong.c ticking.c
CCPATH             = /usr/bin
DKPATH             = /Users/huda/Documents/School/Spring18/2261/Gameboy/devkitARM/bin
VBASIM             = open /Users/huda/Documents/School/Spring18/2261/Gameboy/visualboyadvance-m.app
FIND               = find
COPY               = cp -r
